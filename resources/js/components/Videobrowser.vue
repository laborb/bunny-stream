            ...
            <div id="card">
                <div class="container w-100 lg:w-4/5 mx-auto flex flex-col">
                    <div v-for="video in videos.items">
                        <div
                            v-if="video.status >= 4"
                            class="flex flex-col md:flex-row overflow-hidden bg-white rounded shadow-xl w-full mb-4"
                        >
                            <a
                                :href="
                            ...
                            <div
                                class="w-full md:w-2/3 py-4 px-6 text-gray-800 flex flex-col justify-between"
                            >
                                <div class="flex justify-between">
                                    <a
                                        ...
                                        "
                                        target="_blank"
                                        class="font-semibold text-lg leading-tight truncate mr-6"
                                        >{{ video.title }}</a
                                    >
                                    <div class="flex">
                                        <video-settings
    ...
    methods: {
        ...
        getLinks() {
            ...
            axios
                .request(options)
                .then((response) => {
                    this.directPlayUrl = response.data.directPlayUrl;
